...
<head>
    ...
    <title>@yield('title', 'Seyahat Gideri Yönetim Platformu')</title>
...
<div class="min-h-screen bg-gray-100 flex">
    ...
    <aside class="sidebar">
        <ul>
            ...
            {{-- Yönetici menü başlığı sadece yetkili biri varsa gösterilsin --}}
            @canany(['users.viewAny', 'roles.viewAny', 'permissions.viewAny'])
        ...
        <header class="page-header shadow">
            <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div class="header-content">
                    ...
                    <h1 class="page-title">
                        {{ $header ?? 'Seyahat Gideri Yönetim Platformu' }}
                    </h1>
                </div>
